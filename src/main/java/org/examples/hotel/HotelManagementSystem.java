...
import org.examples.hotel.payment.Payment;
...
public class HotelManagementSystem {
    ...
    public synchronized Reservation bookRoom(Guest guest, Room room, LocalDate checkInDate, LocalDate checkOutDate) throws Exception {
        if (room.getStatus() == RoomStatus.AVAILABLE) {
            try {
                ...
                throw new Exception("Failed to book room: " + e.getMessage(), e);
            }
        }
